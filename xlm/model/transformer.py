...
class TransformerModel(nn.Module):
    ...
    def fwd_embedded(self, x, lengths, causal, src_enc=None, src_len=None, positions=None, langs=None, cache=None):
        """
        Inputs:
            `x` LongTensor(slen, bs), containing word embeddings
        ...
        for i in range(self.n_layers):
            ...
            # self attention
            attn = self.attentions[i](x, attn_mask, cache=cache)
    ...
    def fwd_embed_only(self, x, lengths, causal, src_enc=None, src_len=None, positions=None, langs=None, cache=None):
        """
        Inputs:
